...
export interface CreateCliArgs<M extends Record<string, RootArgs>> {
...
export type CreateCli = <M extends Record<string, RootArgs>>(args: CreateCliArgs<M>) => Cli;
...
export const createCli: CreateCli = ({log, process, commands}) => {
    return {
        async start() {
